package tw.openedu.android.module.analytics;
...
public class ISegmentTrackerImpl implements ISegmentTracker {
    ...
    public ISegmentTrackerImpl(Context context, Config config) {
        try {
            ...
            boolean debugging = context.getResources().getBoolean(tw.openedu.android.R.bool.analytics_debug);
            int queueSize = context.getResources().getInteger(tw.openedu.android.R.integer.analytics_queue_size);
            int flushInterval = context.getResources().getInteger(tw.openedu.android.R.integer.analytics_flush_interval);
