package tw.openedu.android.module.db;
...
import tw.openedu.android.model.course.BlockPath;
...
public class DatabaseModelFactory {
    ...
    /**
     * Returns new instance of {@link tw.openedu.android.model.VideoModel} initialized with given cursor.
     *
     * @param c
     * @return
     */
