...
import tw.openedu.android.interfaces.NetworkObserver;
import tw.openedu.android.interfaces.NetworkSubject;
import tw.openedu.android.loader.AsyncTaskResult;
...
import tw.openedu.android.view.adapters.MyCourseAdapter;
...
public abstract class CourseListTabFragment extends BaseFragment implements NetworkObserver, LoaderManager.LoaderCallbacks<AsyncTaskResult<List<EnrolledCoursesResponse>>> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        offlineBar = view.findViewById(tw.openedu.android.R.id.offline_bar);
        offlinePanel = (LinearLayout) view.findViewById(tw.openedu.android.R.id.offline_panel);
        progressBar = (ProgressBar) view.findViewById(tw.openedu.android.R.id.loading_indicator);
        swipeLayout = (SwipeRefreshLayout) view.findViewById(tw.openedu.android.R.id.swipe_container);
        ...
        swipeLayout.setColorScheme(android.R.color.holo_blue_bright,
                tw.openedu.android.R.color.grey_act_background, tw.openedu.android.R.color.grey_act_background,
                tw.openedu.android.R.color.grey_act_background);

        myCourseList = (ListView) view.findViewById(tw.openedu.android.R.id.my_course_list);
    ...
    private void setupFooter(ListView myCourseList) {
        try {
            View footer = LayoutInflater.from(getActivity()).inflate(tw.openedu.android.R.layout.panel_find_course, null);
            myCourseList.addFooterView(footer, null, false);
            Button course_btn = (Button) footer.findViewById(tw.openedu.android.R.id.course_btn);
            ...
            TextView courseNotListedTv = (TextView) footer.findViewById(tw.openedu.android.R.id.course_not_listed_tv);
    ...
    public void showCourseNotListedDialog() {
        environment.getRouter().showWebViewDialog((getActivity()), getString(tw.openedu.android.R.string.course_not_listed_file_name), null);
    }
}
