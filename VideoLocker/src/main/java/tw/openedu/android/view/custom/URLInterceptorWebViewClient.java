...
import tw.openedu.android.util.ConfigUtil;
import tw.openedu.android.util.NetworkUtil;
import tw.openedu.android.util.StandardCharsets;
import tw.openedu.android.util.links.EdxCourseInfoLink;
import tw.openedu.android.util.links.EdxEnrollLink;
...
public class URLInterceptorWebViewClient extends WebViewClient {
     ...
     * of actions as declared in {@link tw.openedu.android.view.custom.URLInterceptorWebViewClient.IActionListener}.
     *
     ...
     * calls {@link tw.openedu.android.view.custom.URLInterceptorWebViewClient.IActionListener#onClickCourseInfo(String)}
     *
     ...
     * calls {@link tw.openedu.android.view.custom.URLInterceptorWebViewClient.IActionListener#onClickEnroll(String, boolean)}
     *
