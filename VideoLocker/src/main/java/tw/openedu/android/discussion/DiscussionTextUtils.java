...
public abstract class DiscussionTextUtils {
    ...
    public enum AuthorAttributionLabel {
        POST(tw.openedu.android.R.string.post_attribution, tw.openedu.android.R.string.post_attribution_without_label),
        ANSWER(tw.openedu.android.R.string.answer_author_attribution, tw.openedu.android.R.string.answer_author_attribution_without_label),
        ENDORSEMENT(tw.openedu.android.R.string.endorser_attribution, tw.openedu.android.R.string.endorser_attribution_without_label);
    ...
    private static CharSequence getRelativeTimeSpanString(@NonNull Context context, long nowMs,
        ...
        if (nowMs - timeMs < DateUtils.SECOND_IN_MILLIS) {
            return context.getString(tw.openedu.android.R.string.just_now);
        } else {
        ...
        if (response.isEndorsed()) {
            ...
            TextViewCompat.setCompoundDrawablesRelativeWithIntrinsicBounds(
                    ...
                    new IconDrawable(context, FontAwesomeIcons.fa_check_square_o)
                            .sizeRes(context, tw.openedu.android.R.dimen.edx_xxx_small)
                            .colorRes(context, tw.openedu.android.R.color.edx_utility_success),
                    null, null, null);
            switch (thread.getType()) {
                case QUESTION:
                    target.setText(tw.openedu.android.R.string.discussion_responses_answer);
                    break;
                case DISCUSSION:
                default:
                    target.setText(tw.openedu.android.R.string.discussion_responses_endorsed);
                    break;
            }
