package tw.openedu.mobile.services;
...
import tw.openedu.mobile.http.HttpManager;
import tw.openedu.mobile.http.HttpRequestDelegate;
import tw.openedu.mobile.http.HttpRequestEndPoint;
import tw.openedu.mobile.http.IApi;
import tw.openedu.mobile.http.OkHttpUtil;
import tw.openedu.mobile.http.cache.CacheManager;
