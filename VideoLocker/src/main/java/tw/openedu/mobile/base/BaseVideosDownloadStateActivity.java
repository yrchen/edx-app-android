...
public abstract class BaseVideosDownloadStateActivity extends BaseFragmentActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(tw.openedu.mobile.R.menu.download_state, menu);
        MenuItem newProgressMenuItem = menu.findItem(tw.openedu.mobile.R.id.download_progress);
        View progressView = newProgressMenuItem.getActionView();
        ProgressWheel newProgressWheel = (ProgressWheel)
                progressView.findViewById(tw.openedu.mobile.R.id.progress_wheel);
