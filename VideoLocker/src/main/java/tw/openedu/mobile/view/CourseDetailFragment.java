...
import tw.openedu.mobile.course.GetCourseDetailTask;
...
import tw.openedu.mobile.task.EnrollForCourseTask;
import tw.openedu.mobile.task.GetEnrolledCourseTask;
import tw.openedu.mobile.util.WebViewUtil;
import tw.openedu.mobile.util.images.CourseCardUtils;
import tw.openedu.mobile.util.images.TopAnchorFillWidthTransformation;
