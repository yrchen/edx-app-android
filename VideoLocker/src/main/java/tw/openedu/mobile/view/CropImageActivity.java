...
import tw.openedu.mobile.third_party.subscaleview.ImageSource;
import tw.openedu.mobile.user.SaveUriToFileTask;
import tw.openedu.mobile.view.custom.CropImageView;
