...
import tw.openedu.mobile.task.EnqueueDownloadTask;
...
import tw.openedu.mobile.view.adapters.LectureAdapter;
import tw.openedu.mobile.view.dialog.DownloadSizeExceedDialog;
import tw.openedu.mobile.view.dialog.IDialogCallback;
import tw.openedu.mobile.view.dialog.ProgressDialogFragment;
