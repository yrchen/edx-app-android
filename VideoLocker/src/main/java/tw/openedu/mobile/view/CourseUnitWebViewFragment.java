...
import tw.openedu.mobile.event.NetworkConnectivityChangeEvent;
import tw.openedu.mobile.event.SessionIdRefreshEvent;
...
import tw.openedu.mobile.services.EdxCookieManager;
