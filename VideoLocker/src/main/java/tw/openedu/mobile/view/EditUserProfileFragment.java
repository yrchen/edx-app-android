...
import tw.openedu.mobile.event.ProfilePhotoUpdatedEvent;
...
import tw.openedu.mobile.user.DataType;
import tw.openedu.mobile.user.DeleteAccountImageTask;
import tw.openedu.mobile.user.FormDescription;
import tw.openedu.mobile.user.FormField;
import tw.openedu.mobile.user.GetAccountTask;
import tw.openedu.mobile.user.GetProfileFormDescriptionTask;
import tw.openedu.mobile.user.LanguageProficiency;
import tw.openedu.mobile.user.SetAccountImageTask;
import tw.openedu.mobile.user.UpdateAccountTask;
import tw.openedu.mobile.util.InvalidLocaleException;
import tw.openedu.mobile.util.LocaleUtils;
import tw.openedu.mobile.util.ResourceUtil;
import tw.openedu.mobile.util.images.ImageCaptureHelper;
import tw.openedu.mobile.view.custom.popup.menu.PopupMenu;
