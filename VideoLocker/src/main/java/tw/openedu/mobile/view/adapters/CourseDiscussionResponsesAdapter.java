...
import tw.openedu.mobile.task.SetCommentFlaggedTask;
import tw.openedu.mobile.task.SetCommentVotedTask;
import tw.openedu.mobile.task.SetThreadFlaggedTask;
import tw.openedu.mobile.task.SetThreadFollowedTask;
import tw.openedu.mobile.task.SetThreadVotedTask;
import tw.openedu.mobile.util.ResourceUtil;
import tw.openedu.mobile.util.UiUtil;
import tw.openedu.mobile.view.view_holders.AuthorLayoutViewHolder;
import tw.openedu.mobile.view.view_holders.DiscussionSocialLayoutViewHolder;
import tw.openedu.mobile.view.view_holders.NumberResponsesViewHolder;
