package tw.openedu.mobile.module.analytics;
...
public class ISegmentTrackerImpl implements ISegmentTracker {
    ...
    public ISegmentTrackerImpl(Context context, Config config) {
        try {
            ...
            boolean debugging = context.getResources().getBoolean(tw.openedu.mobile.R.bool.analytics_debug);
            int queueSize = context.getResources().getInteger(tw.openedu.mobile.R.integer.analytics_queue_size);
            int flushInterval = context.getResources().getInteger(tw.openedu.mobile.R.integer.analytics_flush_interval);
