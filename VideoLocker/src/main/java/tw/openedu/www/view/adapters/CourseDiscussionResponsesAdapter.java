...
import tw.openedu.www.task.SetCommentFlaggedTask;
import tw.openedu.www.task.SetCommentVotedTask;
import tw.openedu.www.task.SetThreadFlaggedTask;
import tw.openedu.www.task.SetThreadFollowedTask;
import tw.openedu.www.task.SetThreadVotedTask;
import tw.openedu.www.util.ResourceUtil;
import tw.openedu.www.util.UiUtil;
import tw.openedu.www.view.view_holders.AuthorLayoutViewHolder;
import tw.openedu.www.view.view_holders.DiscussionSocialLayoutViewHolder;
import tw.openedu.www.view.view_holders.NumberResponsesViewHolder;
