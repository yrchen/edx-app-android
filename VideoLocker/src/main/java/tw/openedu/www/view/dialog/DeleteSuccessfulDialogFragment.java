...
public class DeleteSuccessfulDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(tw.openedu.www.R.layout.delete_successful_dialog, container,
                false);
        TextView title_tv = (TextView) v.findViewById(tw.openedu.www.R.id.tv_dialog_title);
        TextView dialog_tv_1 = (TextView) v
                .findViewById(tw.openedu.www.R.id.tv_dialog_message1);

        title_tv.setText(getArguments().getString("title"));
        dialog_tv_1.setText(getArguments().getString("dialog_msg_1"));
        // Watch for button clicks.

        Button button = (Button) v.findViewById(tw.openedu.www.R.id.positiveButton);
