package tw.openedu.www.view.custom;
...
public class TitleRowView extends LinearLayout {
    ...
    private void setAttributes(Context context, AttributeSet attrs) {
        ...
        TypedArray attrArray = context.obtainStyledAttributes(attrs, R.styleable.TitleRowView);
        String title = attrArray.getString(R.styleable.TitleRowView_titleText);
        float fontSize = attrArray.getDimension(R.styleable.TitleRowView_titleFontSize, 12.0f);
        DecorationStyle decorationStyle =DecorationStyle.values()[attrArray.getInt(R.styleable.TitleRowView_decorationStyle, DecorationStyle.CENTER.ordinal())];
        int textColor = attrArray.getColor(R.styleable.TitleRowView_android_textColor, Color.BLACK);
        int leftColor = attrArray.getColor(R.styleable.TitleRowView_leftColor, getResources().getColor(R.color.grey_act_background));
        int rightColor = attrArray.getColor(R.styleable.TitleRowView_rightColor, getResources().getColor(R.color.grey_act_background));
