package tw.openedu.www.module.db.impl;
...
import tw.openedu.www.module.db.DbStructure;
...
public class IDatabaseImpl extends IDatabaseBaseImpl implements IDatabase {
    ...
    public Boolean isAnyVideoDownloading(final DataCallback<Boolean> callback) {
        DbOperationExists op = new DbOperationExists(false, DbStructure.Table.DOWNLOADS, null,
                ...
                new String[]{username(), String.valueOf(DownloadEntry.DownloadedState.DOWNLOADING.ordinal())},
                null);
    ...
    public List<Long> getAllDownloadingVideosDmidList(final DataCallback<List<Long>> callback) {
        DbOperationGetColumn<Long> op = new DbOperationGetColumn<Long>(true,
                ...
                new String[]{String.valueOf(DownloadEntry.DownloadedState.DOWNLOADING.ordinal()), username()},
                null, Long.class);
        op.setCallback(callback);
        return enqueue(op);
    }
    ...
    public Integer updateVideoAsOnlineByVideoId(String videoId,
        ...
        values.put(DbStructure.Column.DOWNLOADED, DownloadEntry.DownloadedState.ONLINE.ordinal());
    ...
    public Boolean isVideoDownloadedInChapter(String enrollmentId,
        ...
        DbOperationExists op = new DbOperationExists(false, DbStructure.Table.DOWNLOADS,
                ...
                String.valueOf(DownloadEntry.DownloadedState.DOWNLOADED.ordinal()), username()}, null);
        op.setCallback(callback);
        return enqueue(op);
    }
    ...
    public Integer getVideosCountByChapter(String enrollmentId, String chapter,
        ...
        DbOperationGetCount op = new DbOperationGetCount(false, DbStructure.Table.DOWNLOADS,
                ...
                DbStructure.Column.CHAPTER + "=? AND " + DbStructure.Column.EID + "=? AND "
                        + DbStructure.Column.DOWNLOADED + "!=? AND " + DbStructure.Column.USERNAME
                        + "=?", new String[]{chapter, enrollmentId,
                String.valueOf(DownloadEntry.DownloadedState.ONLINE.ordinal()), username()}, null);
        op.setCallback(callback);
        return enqueue(op);
    }
    ...
    public Boolean isVideoDownloadingInChapter(String enrollmentId,
        ...
        DbOperationExists op = new DbOperationExists(false, DbStructure.Table.DOWNLOADS,
                ...
                DbStructure.Column.CHAPTER + "=? AND " + DbStructure.Column.EID + "=? AND "
                        + DbStructure.Column.DOWNLOADED + "=? AND " + DbStructure.Column.USERNAME
                        + "=?", new String[]{chapter, enrollmentId,
                String.valueOf(DownloadEntry.DownloadedState.DOWNLOADING.ordinal()), username()}, null);
        op.setCallback(callback);
        return enqueue(op);
    }
    ...
    public List<Long> getDownloadingVideoDmIdsForChapter(String enrollmentId,
        ...
        DbOperationGetColumn<Long> op = new DbOperationGetColumn<Long>(true,
                ...
                DbStructure.Column.DOWNLOADED + "=? AND " + DbStructure.Column.EID + "=? AND "
                        ...
                        + "=?",
                new String[]{String.valueOf(DownloadEntry.DownloadedState.DOWNLOADING.ordinal()), enrollmentId,
    ...
    public long[] getDownloadingVideoDmIdsForSection(String enrollmentId, String chapter,
        ...
        DbOperationGetColumn<Long> op = new DbOperationGetColumn<Long>(true,
                ...
                DbStructure.Column.DOWNLOADED + "=? AND " + DbStructure.Column.EID + "=? AND "
                        ...
                        + DbStructure.Column.USERNAME + "=?",
                new String[]{String.valueOf(DownloadEntry.DownloadedState.DOWNLOADING.ordinal()),
    ...
    public long[] getDownloadedVideoDmIdsForSection(String enrollmentId, String chapter,
        ...
        DbOperationGetColumn<Long> op = new DbOperationGetColumn<Long>(true,
                ...
                DbStructure.Column.DOWNLOADED + "=? AND " + DbStructure.Column.EID + "=? AND "
                        ...
                        + DbStructure.Column.SECTION + "=? AND "
                        + DbStructure.Column.USERNAME + "=?",
                new String[]{String.valueOf(DownloadEntry.DownloadedState.DOWNLOADED.ordinal()),
                        enrollmentId, chapter, section, username()}, null, Long.class);
        op.setCallback(callback);
    ...
    @Override
    public Integer updateVideoWatchedState(String videoId, DownloadEntry.WatchedState status,
                                           final DataCallback<Integer> callback) {
        ContentValues values = new ContentValues();
    ...
    public VideoModel getVideoByVideoUrl(String videoUrl,
        ...
        DbOperationGetVideo op = new DbOperationGetVideo(false, DbStructure.Table.DOWNLOADS, null,
                DbStructure.Column.URL + "=? AND " + DbStructure.Column.DOWNLOADED + "!=? AND "
                        + DbStructure.Column.USERNAME + "=?",
                new String[]{videoUrl, String.valueOf(DownloadEntry.DownloadedState.ONLINE.ordinal()),
                        username()}, null);
        op.setCallback(callback);
        return enqueue(op);
    }
    ...
    public Boolean isVideoFilePresentByUrl(String videoUrl, final DataCallback<Boolean> callback) {
        DbOperationExists op = new DbOperationExists(false, DbStructure.Table.DOWNLOADS, null,
                DbStructure.Column.URL + "=? AND " + DbStructure.Column.DOWNLOADED + "=? AND "
                        + DbStructure.Column.USERNAME + "=?",
                new String[]{videoUrl, String.valueOf(DownloadEntry.DownloadedState.DOWNLOADED.ordinal()),
                        username()}, null);
        op.setCallback(callback);
        return enqueue(op);
    }
    ...
    public Integer updateAsDownloadingByVideoId(VideoModel model,
        ...
        ContentValues values = new ContentValues();
        values.put(DbStructure.Column.DM_ID, model.getDmId());
        values.put(DbStructure.Column.DOWNLOADED, DownloadEntry.DownloadedState.DOWNLOADING.ordinal());
    ...
    public Integer getDownloadedVideoCountByCourse(String courseId,
        ...
        DbOperationGetCount op = new DbOperationGetCount(true, DbStructure.Table.DOWNLOADS,
                ...
                DbStructure.Column.EID + "=? AND " + DbStructure.Column.DOWNLOADED + "=? AND "
                        + DbStructure.Column.USERNAME + "=?",
                new String[]{courseId, String.valueOf(DownloadEntry.DownloadedState.DOWNLOADED.ordinal()),
                        username()}, null);
        op.setCallback(callback);
        return enqueue(op);
    }
    ...
    public Long getDownloadedVideosSizeByCourse(String courseId,
        ...
        DbOperationSingleValueByRawQuery<Long> op = new DbOperationSingleValueByRawQuery<Long>(
                ...
                new String[]{courseId, username(),
                        String.valueOf(DownloadEntry.DownloadedState.DOWNLOADED.ordinal())}, Long.class);
        op.setCallback(callback);
        return enqueue(op);
    }
    ...
    public List<VideoModel> getSortedDownloadsByDownloadedDateForCourseId(String courseId,
        ...
        DbOperationGetVideos op = new DbOperationGetVideos(false, DbStructure.Table.DOWNLOADS, null,
                ...
                new String[]{courseId, String.valueOf(
                        DownloadEntry.DownloadedState.DOWNLOADED.ordinal()), username()},
    ...
    public Integer updateDownloadCompleteInfoByDmId(long dmId,
        ...
        DbOperationUpdate op = new DbOperationUpdate(DbStructure.Table.DOWNLOADS, values,
                ...
                new String[]{String.valueOf(dmId),
                        String.valueOf(DownloadEntry.DownloadedState.ONLINE.ordinal())});
        op.setCallback(callback);
        return enqueue(op);
    }
    ...
    @Override
    public DownloadEntry.WatchedState getWatchedStateForVideoId(String videoId,
                                                  final DataCallback<DownloadEntry.WatchedState> dataCallback) {
        ...
        op.setCallback(new DataCallback<List<Integer>>() {
            ...
            public void onResult(List<Integer> ordinals) {
                if (ordinals != null && !ordinals.isEmpty()) {
                    dataCallback.sendResult(DownloadEntry.WatchedState.values()[ordinals.get(0)]);
                } else {
    ...
    public VideoModel getDownloadEntryByDmId(long dmId,
        ...
        DbOperationGetVideo op = new DbOperationGetVideo(false, DbStructure.Table.DOWNLOADS, null,
                DbStructure.Column.DM_ID + "=? AND " + DbStructure.Column.DOWNLOADED + "=?",
                new String[]{String.valueOf(dmId), String.valueOf(DownloadEntry.DownloadedState
    ...
    @Override
    public DownloadEntry.DownloadedState getDownloadedStateForVideoId(String videoId,
            final DataCallback<DownloadEntry.DownloadedState> dataCallback) {
        DbOperationGetColumn<Integer> op = new DbOperationGetColumn<Integer>(false,
        ...
        op.setCallback(new DataCallback<List<Integer>>() {
            ...
            public void onResult(List<Integer> ordinals) {
                if (ordinals != null && !ordinals.isEmpty()) {
                    dataCallback.sendResult(DownloadEntry.DownloadedState.values()[ordinals.get(0)]);
                } else {
    ...
    public Boolean isAnyVideoDownloadingInCourse(final DataCallback<Boolean> callback,
        ...
        DbOperationExists op = new DbOperationExists(false, DbStructure.Table.DOWNLOADS, null,
                DbStructure.Column.EID + "=? AND " + DbStructure.Column.USERNAME + "=? AND "
                        + DbStructure.Column.DOWNLOADED + "=?",
                new String[]{courseId, username(),
                        String.valueOf(DownloadEntry.DownloadedState.DOWNLOADING.ordinal())}, null);
        op.setCallback(callback);
        return enqueue(op);
    }
