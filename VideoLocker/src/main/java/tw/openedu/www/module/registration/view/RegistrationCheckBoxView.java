...
class RegistrationCheckBoxView implements IRegistrationFieldView {
    ...
    public RegistrationCheckBoxView(RegistrationFormField field, View view) {
        ...
        this.mInputView = (CheckBox) view.findViewById(tw.openedu.www.R.id.checkbox_input);
        this.mErrorView = (TextView) view.findViewById(tw.openedu.www.R.id.checkbox_input_error);
        this.mInstructionView = (TextView) view.findViewById(tw.openedu.www.R.id.checkbox_input_instruction);
