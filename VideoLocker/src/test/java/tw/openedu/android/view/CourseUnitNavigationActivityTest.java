...
import tw.openedu.android.model.course.EncodedVideos;
...
import tw.openedu.android.view.adapters.CourseUnitPagerAdapter;
import tw.openedu.android.view.custom.DisableableViewPager;
...
public class CourseUnitNavigationActivityTest extends CourseBaseActivityTest {
    ...
    public static class ParameterizedFragmentCreation extends UiTest {
        ...
        public void test() throws IOException {
            config = new tw.openedu.android.util.Config(generateConfigProperties());
